  ...
  return (
    <div className="content">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.email && <IonText color="danger">Please enter an email</IonText>}
        <IonItem class="input-field">
        ...
        <IonItem class="input-field">
          ...
          <IonInput type="password" {...register("password_repeat", { required: true })} />
        </IonItem>
        {errors.password_repeat && <IonText color="danger">{errors.password_repeat?.message}</IonText>}
