			...
			<IonPage>
				<div style={{ height: '100vh', width: '100%' }}>
					<GoogleMapReact
						...
						<Marker lat={51.45079} lng={5.471861} text='Lidl' />
						<Marker lat={51.451563} lng={5.472298} text='Albert Heijn' />
						<Marker lat={51.449972} lng={5.472884} text='The Food Corner' />
						<Marker lat={51.448399} lng={5.474719} text='Athene' />
						<Marker lat={51.449359} lng={5.473838} text='Kam Po' />
						<Marker lat={51.447382} lng={5.475611} text='Sri Ganesh Indiaas' />
					</GoogleMapReact>
				</div>
			</IonPage>
		);
